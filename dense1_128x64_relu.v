...
wire feature_mem_we;
wire [6:0] feature_wr_addr;
wire signed [63:0] feature_wr_data;
...
always @(posedge clk) begin
    if (feature_mem_we) begin
        feature_mem[feature_wr_addr] <= feature_wr_data;
    end
